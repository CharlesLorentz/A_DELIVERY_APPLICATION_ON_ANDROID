...
public class edit_Dao {
    ...
    public edit_Dao(Context context){
...
//        super(context, name, factory, version);
     ...
     * */
    public boolean insertEdit(String Type, String sendNum, String finishNum, String Content, float  Grade1,float Grade2,float Grade3){
        ContentValues values = new ContentValues();
//        values.put("ID", ID);
        values.put("Type", Type);
        values.put("sendNum", sendNum);
        values.put("finishNum", finishNum);
        ...
        long id = sqLiteDatabase.insert("comment",null, values);
